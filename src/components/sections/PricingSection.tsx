    ...
    <section className="py-24 px-4 bg-[#e7e5db]" id="pricing">
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <h2 className="font-jersey-25 text-3xl md:text-4xl font-semibold text-foreground mb-2">
            Choose Your Plan
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {tiers.map((tier, index) => (
            <motion.div
              ...
              className={`relative bg-card rounded-2xl p-6 md:p-7 shadow-soft border-2 transition-colors duration-300 ${
                tier.popular
                  ? 'border-foreground/50 md:scale-105 shadow-card'
            ...
            >
              ...
              {tier.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                  <span className="bg-foreground text-primary-foreground px-3 py-0.5 rounded-full text-xs font-semibold font-jersey">
                    POPULAR
                  </span>
                </div>
              )}
              ...
              {/* Tier name */}
              <div className="mb-4">
                <h3 className="font-jersey-25 text-2xl md:text-3xl font-semibold text-foreground mb-1">
                  {tier.name}
                </h3>
              </div>
              ...
              <div className="mb-6">
                <div className="flex items-baseline gap-2">
                  <span className="font-jersey text-4xl md:text-5xl font-semibold text-foreground">
                    {tier.price}
                  </span>
                  {tier.price !== "$0" && (
              ...
              <ul className="space-y-2.5 mb-6">
                {tier.features.map((feature, featureIndex) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-muted-foreground font-body leading-snug">
                      {feature}
                    </span>
                  </motion.li>
                ))}
